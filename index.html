...
function initDomRefs(){
  const ids = ['worldCanvas','introGate','enterBtn','kliwonBtn','ghostHuntBtn','miniGameBtn','qualityBtn','cameraBtn','respawnBtn','resetBtn','muteBtn','panicBtn','toast','infoContent','legendItems','searchInput','mSpeed','hudSpeed','mLegend','mRelic','mSanity','dangerText','dangerFill','nearHint','gamePanel','gameProgress','gameStatus','scenarioTitle','scenarioText','miniMap','jumpscareOverlay','jumpscareImage','jumpscareCaption','flashLayer','bloodText'];
...
function onKeyDown(e){
  switch(e.code){
    ...
    case 'Enter': interactNearest(); break;
